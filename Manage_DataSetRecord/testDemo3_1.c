...
static void testgenerate_tableAndInsert(void);
...
// ************************************************************ 
void testgenerate_tableAndInsert(void)
{
...
void testInsertManyRecords(void)
{
	...
	TEST_CHECK(initRManager(NULL));
	TEST_CHECK(generate_table("test_table_t", schema));
